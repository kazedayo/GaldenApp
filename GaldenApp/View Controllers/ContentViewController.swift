    ...
    */
    ...
    @objc func handleBBCodeToHTMLNotification(notification: Notification) {
        if let html = notification.object as? String {
            let newContent = "<html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style type=\"text/css\"> body { color: white; background-color: black; font-family:helvetica; font-size:15 } img{ max-width:280px; } blockquote {color: grey;} a {overflow-wrap: break-word; word-wrap: break-word;} .xbbcode-size-1 {font-size:xx-small;}.xbbcode-size-2 {font-size:x-small;}.xbbcode-size-3 {font-size:medium;}.xbbcode-size-4 {font-size:large;}.xbbcode-size-5 {font-size:x-large;}.xbbcode-size-6 {font-size:xx-large;} .xbbcode-hide {color: #ffccd5}</style></head><body>\(html)</body></html>"
