...
class ContentTableViewCell: UITableViewCell {
    ...
    func configureOP(opData: OP) {
        ...
        contentTextView.attributedText = opData.contentAttr
    ...
    func configureReplyFirstPage(comments: [Replies],indexPath: IndexPath,pageNow: Int) {
        ...
        contentTextView.attributedText = comments[indexPath.row - 1].contentAttr
    ...
    func configureReply(comments: [Replies],indexPath: IndexPath,pageNow: Int) {
        ...
        contentTextView.attributedText = comments[indexPath.row].contentAttr
